...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 35.7989;
        FollowerConstants.yMovement = 41.7915;

        FollowerConstants.forwardZeroPowerAcceleration = -18.2316;
        FollowerConstants.lateralZeroPowerAcceleration = -80;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.15,0,0.03,0);
